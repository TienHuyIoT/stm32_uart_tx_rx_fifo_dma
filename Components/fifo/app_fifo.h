 ...
 * @retval     APP_FIFO_ERROR           If a NULL pointer is provided as buffer.
 * @retval     APP_FIFO_ERROR 			If size of buffer provided is not a power of two.
 */
 ...
 * @retval     APP_FIFO_ERROR         	If the FIFO is full.
 */
 ...
 * @retval     APP_FIFO_ERROR      		If there are no more elements in the queue.
 */
 ...
 *
 * @retval     APP_FIFO_OK              If an element was returned.
 * @retval     APP_FIFO_ERROR      		If there are no more elements in the queue, or the index was
 *                                      too large.
 */
 ...
 *                                  successful.
 * @retval     APP_FIFO_ERROR       If a NULL parameter was passed for a parameter that must not
 *                                  be NULL.
 * @retval     APP_FIFO_ERROR  		If the FIFO is empty.
 */
